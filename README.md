...
## | [Script Extractor](https://github.com/Ricardouchub/Proyecto-clima-Chile-API-dashboard/blob/main/extractor_clima_script.py) | [Notebook de Análisis](https://github.com/Ricardouchub/Proyecto-clima-Chile-API-dashboard/blob/main/Notebook.ipynb) | [Dashboard](https://proyecto-clima-chile-api-dashboard.onrender.com) |
